...
<script>
 ...
 buttAdd.onclick = function()
    {
      location.href = '../../controller.php?action=categs&actionType=editTable&id=-1';
    }
    butEdit.onclick = function()
    {
	 ...
	 if(selId==-1)
      ...
      location.href = "../../controller.php?action=categs&actionType=editTable&id="+selId;
    }
    butDel.onclick = function()
    {
	 ...
	 if(selId==-1)
      ...
      location.href = "../../controller.php?action=categs&actionType=deleteTable&id="+selId;
    }
</script>