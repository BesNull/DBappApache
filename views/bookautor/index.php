...
<link rel="stylesheet" type="text/css" href="../../styles/style.css">
 ...
 <h1 align="center">Авторы книг</h1>
...
<script>
 ...
 buttAdd.onclick = function()
    {
      location.href = '../../controller.php?action=bookautor&actionType=editTable&id=-1';
    }
    butEdit.onclick = function()
    {
	 ...
	 if(selId==-1)
      ...
      location.href = "../../controller.php?action=bookautor&actionType=editTable&id="+selId;
    }
    butDel.onclick = function()
    {
	 ...
	 if(selId==-1)
      ...
      location.href = "../../controller.php?action=bookautor&actionType=deleteTable&id="+selId;
    }
</script>