...
<script>
 ...
 buttAdd.onclick = function()
    {
      location.href = '../../controller.php?action=orders&actionType=editTable&id=-1';
    }
    butEdit.onclick = function()
    {
	 ...
	 if(selId==-1)
      ...
      location.href = "../../controller.php?action=orders&actionType=editTable&id="+selId;
    }
    butDel.onclick = function()
    {
	 ...
	 if(selId==-1)
      ...
      location.href = "../../controller.php?action=orders&actionType=deleteTable&id="+selId;
    }
</script>