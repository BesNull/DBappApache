...
clickRb=function(id)
 ...
 buttAdd.onclick = function()
    {
      location.href = '../../controller.php?action=autor&actionType=editTable&id=-1';
    }
    butEdit.onclick = function()
    {
	 ...
	 if(selId==-1)
      ...
      location.href = "../../controller.php?action=autor&actionType=editTable&id="+selId;
    }
    butDel.onclick = function()
    {
	 ...
	 if(selId==-1)
      ...
      location.href = "../../controller.php?action=autor&actionType=deleteTable&id="+selId;
    }
</script>