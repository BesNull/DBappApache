...
<script>
 ...
 buttAdd.onclick = function()
    {
      location.href = '../../controller.php?action=korz&actionType=editTable&id=-1';
    }
    butEdit.onclick = function()
    {
	 ...
	 if(selId==-1)
      ...
      location.href = "../../controller.php?action=korz&actionType=editTable&id="+selId;
    }
    butDel.onclick = function()
    {
	 ...
	 if(selId==-1)
      ...
      location.href = "../../controller.php?action=korz&actionType=deleteTable&id="+selId;
    }
</script>